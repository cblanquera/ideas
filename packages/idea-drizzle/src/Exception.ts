...
export default class Exception extends Error {
   ...
   */
  static forErrorsFound(errors: Record<string, string>|Record<string, string>[]): Exception {
  ...
  /**
   * Expressive way to set errors
   */
  withErrors(errors: Record<string, any>): Exception {
    this.errors = errors;
    return this;
  }

  /**
   * Converts error to API Response
   */
  toResponse(): ResponsePayload {
